<template>
    <div class="container">
        <!-- 移动盒子 -->
        <div class="box" @mousedown="handleMouseDown" :style="{
            left: posLeft + 'px',
            top: posTop + 'px'
        }" ref="moveBox"></div>
        <!-- 盛放容器 -->
...
let posLeft = ref<number>(10) // 移动元素左上角距离视口的left
let posTop = ref<number>(10) // 移动元素左上角距离视口的top
...
const handelMouseUp = () => {
    ...
    // 移动元素的左下角、右下角
    const curLeftBottom = [posLeft.value, moveBoxRect.bottom]
